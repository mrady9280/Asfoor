...
#pragma warning restore OPENAI001
    ...
    public async Task<ChatClientAgent> CreateSmartChatAgentAsync()
    {
        ...
        var webSearchFunc = AIFunctionFactory.Create(_tools.WebSearchAsync, "web-search-tool", "Performs a web search to find information on the internet. Use this when you need current information or answers not found in your memory.");
...
#pragma warning restore OPENAI001
        ...
        string? reasoningEffortLevel = null)
    {
        ...
        var searchFunc = AIFunctionFactory.Create(_tools.ScraperWebSearchAsync, "search-tool");
        // var webSearchFunc = AIFunctionFactory.Create(_tools.WebSearchAsync, "web-search-tool", "Performs a web search to find information on the internet. Use this when you need current information or answers not found in your memory.");
        var analyzeImagesFunc = AIFunctionFactory.Create(_tools.CreateAnalyzeImagesFunc(attachments), "AnalyzeImages",
